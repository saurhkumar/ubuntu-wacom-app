...
static void activate(GtkApplication *app, gpointer user_data) {
    ...
    gtk_window_set_title(GTK_WINDOW(window), "Ubuntu Wacom Tablet App");
...
int main(int argc, char *argv[]) {
    ...
    GtkApplication *app = gtk_application_new("org.example.WacomTabletApp", G_APPLICATION_FLAGS_NONE);
